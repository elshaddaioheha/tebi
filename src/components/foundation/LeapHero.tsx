    ...
    <section ref={containerRef} className="relative min-h-[90vh] lg:min-h-screen flex items-center pt-24 pb-16 px-6 md:px-12 lg:px-20 overflow-hidden bg-[#FBF7EE]">
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        <div className="lg:col-span-6 flex flex-col items-start text-left relative">
          ...
          <div className="gsap-hero-doodles opacity-0 absolute -bottom-24 -left-12 w-28 h-28 text-gold/30 pointer-events-none select-none z-0">
          ...
          {/* Logo Badge */}
          <div className="gsap-hero-logo mb-6 opacity-0 z-10">
          ...
          {/* Tagline / Subtitle */}
          <span className="gsap-hero-tag opacity-0 font-body text-[10px] md:text-xs uppercase tracking-[0.35em] text-gold font-bold mb-4 block z-10">
            Emma Collins Center For
          </span>

          {/* Hero Main Header */}
          <h1 className="gsap-hero-heading opacity-0 font-display font-light text-4xl md:text-5xl lg:text-6xl text-[#0B1F3A] mb-6 leading-tight tracking-tight max-w-2xl z-10">
          ...
          {/* Description */}
          <p className="gsap-hero-desc opacity-0 font-body text-base text-[#0B1F3A]/70 mb-8 max-w-xl leading-relaxed z-10">
          ...
          <div className="gsap-hero-actions opacity-0 flex flex-col sm:flex-row gap-6 items-center w-full z-10">
            <button
            ...
            <div className="gsap-hero-social flex items-center gap-4">
        ...
        <div className="gsap-hero-media opacity-0 lg:col-span-6 flex justify-center items-center relative w-full">
          {/* Hand-drawn Sun Doodle */}
          <div className="gsap-hero-doodles opacity-0 absolute -top-12 -left-8 md:-top-16 md:-left-12 w-28 h-28 text-gold/40 pointer-events-none select-none z-0">
            <svg className="w-full h-full" viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
              {/* Hand-drawn sun circle */}
          ...
          <div className="relative w-full max-w-lg md:max-w-xl aspect-[4/3] rounded-[2rem] md:rounded-[2.5rem] border-[6px] md:border-[10px] border-[#0B1F3A] bg-[#0B1F3A] shadow-2xl shadow-[#0B1F3A]/20 overflow-hidden z-10">
            ...
            {/* Soft inner vignette reflection effect */}
      ...
      <button
        onClick={scrollToContent}
        className="gsap-hero-scroll opacity-0 absolute bottom-4 left-1/2 -translate-x-1/2 hidden lg:flex flex-col items-center gap-1.5 text-[#0B1F3A]/30 hover:text-gold transition-colors duration-300 cursor-pointer z-20"
      >
